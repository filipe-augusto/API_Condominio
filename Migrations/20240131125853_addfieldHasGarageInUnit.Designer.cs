...
namespace API_Condominio.Migrations
{
    ...
    [Migration("20240131125853_addfieldHasGarageInUnit")]
    partial class addfieldHasGarageInUnit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API_Condominio.Models.Block", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("API_Condominio.Models.Resident", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("CreationDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 1, 31, 9, 58, 53, 124, DateTimeKind.Local).AddTicks(3022))
            ...
            modelBuilder.Entity("API_Condominio.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API_Condominio.Models.Sex", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("API_Condominio.Models.Unit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API_Condominio.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API_Condominio.Models.Resident", b =>
                {
                    b.HasOne("API_Condominio.Models.Sex", "Sex")
                        .WithMany("Residents")
                        .HasForeignKey("SexId")
                    ...
                    b.HasOne("API_Condominio.Models.Unit", "Unit")
                        .WithMany("Residents")
            ...
            modelBuilder.Entity("API_Condominio.Models.Unit", b =>
                {
                    b.HasOne("API_Condominio.Models.Block", "Block")
                        .WithMany("Units")
            ...
            modelBuilder.Entity("UserRole", b =>
                {
                    b.HasOne("API_Condominio.Models.Role", null)
                        .WithMany()
                    ...
                    b.HasOne("API_Condominio.Models.User", null)
                        .WithMany()
